...
// ----------------------------------------------------------------------
void OpenPendantComponent::printCrcDebug(const UsbInPackage& inPackage, const UsbOutPackageData& outPackageBuffer) const
{
    std::ios init(NULL);
...
void OpenPendantComponent::onInputDataReceived(const UsbInPackage& inPackage)
{
    *mRxCout << "in    ";
...
// ----------------------------------------------------------------------
void OpenPendantComponent::printPushButtonText(uint8_t keyCode, uint8_t modifierCode, std::ostream& out)
{
    std::ios init(NULL);
    init.copyfmt(out);
    int indent = 15;
...
// ----------------------------------------------------------------------
void OpenPendantComponent::printRotaryButtonText(const KeyCode* keyCodesBase, uint8_t keyCode, std::ostream& out)
{
    std::ios init(NULL);
    init.copyfmt(out);
...
// ----------------------------------------------------------------------
void OpenPendantComponent::printInputData(const UsbInPackage& inPackage, std::ostream& out)
{
    std::ios init(NULL);
    init.copyfmt(out);
...
// ----------------------------------------------------------------------
void OpenPendantComponent::printHexdump(const UsbInPackage& inPackage, std::ostream& out)
{
    std::ios init(NULL);
    init.copyfmt(out);
...
// ----------------------------------------------------------------------
void OpenPendantComponent::printPushButtonText(uint8_t keyCode, uint8_t modifierCode)
{
    printPushButtonText(keyCode, modifierCode, *mRxCout);
}
// ----------------------------------------------------------------------
void OpenPendantComponent::printRotaryButtonText(const KeyCode* keyCodesBase, uint8_t keyCode)
{
    printRotaryButtonText(keyCodesBase, keyCode, *mRxCout);
}
// ----------------------------------------------------------------------
void OpenPendantComponent::printInputData(const UsbInPackage& inPackage)
{
    printInputData(inPackage, *mRxCout);
}
// ----------------------------------------------------------------------
void OpenPendantComponent::printHexdump(const UsbInPackage& inPackage)
{
...
// ----------------------------------------------------------------------
void OpenPendantComponent::setEnableVerboseKeyEvents(bool enable)
{
    mUsb.enableVerboseRx(enable);
    if (enable)
    {
...
// ----------------------------------------------------------------------
void OpenPendantComponent::enableCrcDebugging(bool enable)
{
    mIsCrcDebuggingEnabled = enable;
}
// ----------------------------------------------------------------------
void OpenPendantComponent::setLeadModeSpindle(bool enable)
{
    mPendant.setLeadModeSpindle(enable);
}
// ----------------------------------------------------------------------
void OpenPendantComponent::setLeadModeFeed(bool enable)
{
    mPendant.setLeadModeFeed(enable);
}
// ----------------------------------------------------------------------
void OpenPendantComponent::setStepMode_5_10(bool enable)
{
